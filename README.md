...
Given a CSV file of an athlete's biomechanical data it will return percentile rankings for all biomehanical metrics in the form of a CSV. It will also return a composite biomechanics score calculated using metric weights using the original neural network and the percentile rankings.
